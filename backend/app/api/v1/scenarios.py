...
def list_osemosys_values_wide(
    ...
    season_codes: str | None = None,
    daytype_codes: str | None = None,
    dailytimebracket_codes: str | None = None,
    storage_codes: str | None = None,
    ...
    try:
        return ScenarioService.list_osemosys_values_wide(
            ...
            mode_codes=_parse_csv_list(mode_codes),
            season_codes=_parse_csv_list(season_codes),
            daytype_codes=_parse_csv_list(daytype_codes),
            dailytimebracket_codes=_parse_csv_list(dailytimebracket_codes),
            storage_codes=_parse_csv_list(storage_codes),
